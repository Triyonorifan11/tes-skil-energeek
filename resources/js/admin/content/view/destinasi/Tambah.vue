                    ...
                    <div class="card card-flush mt-5 mb-5 mb-xl-10" id="kt_profile_details_view">
                        <div class="card card-xl-stretch mb-5 mb-xl-8">
                            <div class="card-header border-0 pt-5 align-items-center">
                                <div class="judul">
                                    <h2 class="text-gray-700">Tambah Destinasi Wisata</h2>
                                                ...
                                                <div class="card-body">
                                                    <div class="row my-3" v-for="(context, index) in form.data.tickets">
                                                        ...
                                                        <div class="col-md-1 d-flex align-items-center">
                                                            <div class="form-check form-check-custom form-check-solid">
                                                                <input @click="clickFree(index)" class="form-check-input me-2" type="checkbox" :id="`free-${index}`"/>
                                        ...
                                        <div class="card" style="border:1px dashed green;">
                                            <div class="card-body">
                                                <div class="row my-3" v-for="(context, index) in form.data.openingHours">
                                                    ...
                                                    <div class="col-md-3">
                                                        <app-datepicker v-model:value="context.startTime" :disabled="context.isClose" type="time" input-class="form-control" input-style="width:100%;" format="HH:mm:ss" value-type="HH:mm:ss" placeholder="Jam mulai"></app-datepicker>
                                                    </div>
                                                    <div class="col-md-1 d-flex align-items-center justify-content-center">s/d</div>
                                                    <div class="col-md-3">
                                                        <app-datepicker v-model:value="context.endTime" :disabled="context.isClose" type="time" input-class="form-control" input-style="width:100%;" format="HH:mm:ss" value-type="HH:mm:ss" placeholder="Jam Tutup"></app-datepicker>
                                                    </div>
                                                    <div class="col-md-1 d-flex align-items-center">
                                                        <div class="form-check form-check-custom form-check-solid">
                                                            <input @click="clickClose(index)" class="form-check-input me-2" type="checkbox" :id="`close-${index}`"/>
                                        ...
                                        <div class="card-body p-5">
                                            <table class="table">
                                                <tr v-for="(context,index) in form?.data?.socialMedia">
                                                    ...
                                                    <td><input :disabled="!context.isActive" v-model="context.urlAccount" type="text" class="form-control" placeholder="Masukkan URL sosial media"></td>
                                                    <td style="width:10%;">
                                                        <div class="m-auto form-check form-switch form-check-custom form-check-solid">
                                                            <input class="m-auto form-check-input abang h-30px w-50px" type="checkbox" v-model="context.isActive" @change="context.urlAccount = ''"/>
                                                        </div>
                                                    </td>
                                                </tr>
                                            </table>
        ...
        methods: {
            ...
            simpan(){
                ...
                $.each(data.socialMedia, function(i,val){
                    if(val.urlAccount && val.isActive){
                        data.socialMedias.push({
                            socialMedia: val.name,
                            urlAccount: val.urlAccount,
                ...
                this.$ewpLoadingShow();
                this.$axios().post(`tourist-destination`,data)
                .then(res => {
                    let data = res?.data?.data;
...
<style scoped>
    ...
    .form-check-custom.form-check-solid .form-check-input.abang:checked{
