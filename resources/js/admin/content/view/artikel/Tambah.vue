                    ...
                    <div class="card card-flush mt-5 mb-5 mb-xl-10" id="kt_profile_details_view">
                        <div class="card card-xl-stretch mb-5 mb-xl-8">
                            <div class="card-header border-0 pt-5 align-items-center">
                                <div class="judul">
                                    <h2 class="text-gray-700">Tulis Artikel</h2>
                                    <span class="text-gray-700">Tambah artikel pada aplikasi Tourism Surabaya -
                                        Disbudporapar Kota Surabaya</span>
                                </div>
                            ...
                            <div class="card-body">
                                <div class="row wrap-heading">
                                    <div class="col-md-8">
                                        <div class="judul">
                                            ...
                                            <input v-model="form.data.title" type="text" id="title" class="form-control"
                                                placeholder="Masukkan judul artikel">
                                        </div>
                                        <br>
                                        <div class="heading">
                                            <label for="heading">Heading</label>
                                            <input v-model="form.data.heading" type="text" id="heading"
                                                class="form-control" placeholder="Masukkan judul artikel">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <span>Thumbnail</span>
                                        <div class="dropzone bg-light-primary" id="dropzone-thumbnail"
                                            style="background-color:lightgray !important; border:none; height:100%; position:relative;">
                                ...
                                <!-- <editor :api-key="tinyApiKey" v-if="initTiny" v-model="form.data.description"
                                    :init="initTiny" /> -->
                                <!-- <app-tinymce v-if="initTiny" v-model="form.data.description" :init="initTiny"></app-tinymce> -->
                                <br><br>
                                <div class="d-flex flex-column justify-content-center align-items-center">
                                    <button class="btn btn-success btn-sm" @click="simpan()">Publikasi Artikel</button>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    export default {
        ...
        methods: {
            ...
            simpan() {
                ...
                if (this.form.thumbnail.files.length < 1) {
                    toastr.warning('File thumbnail wajib di isi!');
                    return false;
                }

                this.$ewpLoadingShow();
                this.$axios().post(`article`, this.form.data)
                    .then(res => {
