                    ...
                    <div class="card card-flush mt-5 mb-5 mb-xl-10" id="kt_profile_details_view">
                        <div class="card card-xl-stretch mb-5 mb-xl-8">
                            <div class="card-header border-0 pt-5 align-items-center">
                                <div class="judul">
                                    <h2 class="text-gray-700">Master Kategori Wisata</h2>
                                    <span class="text-gray-700">Daftar kategori wisata pada aplikasi Tourism Surabaya - Disbudporapar Kota Surabaya</span>
                                </div>
                                <div class="button">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <div class="m-auto" style="width:100%;">
                            <div class="d-flex flex-column justify-content-center align-items-center">
                                <h2 class="modal-title text-gray-700">{{ form.isEdit ? 'Edit' : 'Tambah' }} Kategori Wisata</h2>
                    ...
                    <div class="modal-body">
                        <label for="name">Kategori Wisata</label>
                        <input v-model="form.data.name" type="text" id="name" class="form-control" placeholder="Contoh: Museum">
                    </div>
    ...
    export default {
        ...
        methods: {
            getDataTable(){
                ...
                this.$axios().get(`master/tourism-category`, {params: this.tableConfig?.config})
                    .then(res => {
            ...
            simpan(){
                ...
                this.$ewpLoadingShow();
                this.$axios().post(`master/tourism-category`, this?.form?.data)
                    .then(res => {
                        $(`.modal`).modal('hide');
            ...
            update(){
                ...
                this.$ewpLoadingShow();
                this.$axios().put(`master/tourism-category/${this?.form?.idEdit}`, this?.form?.data)
                    .then(res => {
                        $(`.modal`).modal('hide');
                        Swal.fire('Berhasil','Data berhasil disimpan.','success');
                        this.getDataTable();
            ...
            switchStatus(id){
                ...
                this.$ewpLoadingShow();
                this.$axios().put(`master/tourism-category/switch-status/${id}`)
                    .then(res => {
                        $(`.modal`).modal('hide');
