...
export default {
    ...
    methods: {
        ...
        getDataTable() {
            ...
            this.$axios().get(`master/skill`, { params: this.tableConfig?.config })
                .then(res => {
        ...
        simpan() {
            ...
            this.$ewpLoadingShow();
            this.$axios().post(`master/skill`, this?.form?.data)
                .then(res => {
                    $(`.modal`).modal('hide');
        ...
        update() {
            ...
            this.$ewpLoadingShow();
            this.$axios().put(`master/skill/${this?.form?.idEdit}`, this?.form?.data)
                .then(res => {
                    $(`.modal`).modal('hide');
                    Swal.fire('Berhasil', 'Data berhasil disimpan', 'success');
                    this.getDataTable();
        ...
        async destroy(data) {
            ...
            if (res) {
                this.$ewpLoadingShow();
                this.$axios().delete(`master/skill/${id}`)
                    .then(res => {
                        $(`.modal`).modal('hide');
