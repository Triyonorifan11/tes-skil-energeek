                    ...
                    <div class="card card-flush mt-5 mb-5 mb-xl-10" id="kt_profile_details_view">
                        <div class="card card-xl-stretch mb-5 mb-xl-8">
                            <div class="card-header border-0 pt-5 align-items-center">
                                <div class="judul">
                                    <h2 class="text-gray-700">Master Bahasa</h2>
                                    <span class="text-gray-700">Daftar bahasa pada aplikasi Tourism Surabaya - Disbudporapar Kota Surabaya</span>
                                </div>
                                <div class="button">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <div class="m-auto" style="width:100%;">
                            <div class="d-flex flex-column justify-content-center align-items-center">
                                <h2 class="modal-title text-gray-700">{{ form.isEdit ? 'Edit' : 'Tambah' }} Bahasa</h2>
                    ...
                    <div class="modal-body">
                        ...
                        <input v-model="form.data.name" type="text" id="name" class="form-control" placeholder="Contoh: Indonesia">
                        <br>
                        <label for="code">Kode</label>
                        <input v-model="form.data.code" type="text" id="code" class="form-control" placeholder="Contoh: ID">
                    </div>
    ...
    export default {
        ...
        methods: {
            getDataTable(){
                ...
                this.$axios().get(`master/language`, {params: this.tableConfig?.config})
                    .then(res => {
            ...
            simpan(){
                ...
                this.$ewpLoadingShow();
                this.$axios().post(`master/language`, this?.form?.data)
                    .then(res => {
                        $(`.modal`).modal('hide');
            ...
            update(){
                ...
                this.$ewpLoadingShow();
                this.$axios().put(`master/language/${this?.form?.idEdit}`, this?.form?.data)
                    .then(res => {
                        $(`.modal`).modal('hide');
                        Swal.fire('Berhasil','Data berhasil disimpan','success');
                        this.getDataTable();
            ...
            switchStatus(id){
                ...
                this.$ewpLoadingShow();
                this.$axios().put(`master/language/switch-status/${id}`)
                    .then(res => {
                        $(`.modal`).modal('hide');
