        ...
        <div class="content bg-content-custom">
            ...
            <section class="pt-5 pb-5" v-if="showContent">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-3">
                            <div class="fw-bolder fs-5">Eat & Drink</div>
                        </div>
                        <div class="col-lg-9">
                        ...
                        <div class="col-lg-3">
                            <div class="bg-white w-100 p-3 filter-grid-item mb-3"
                                ...
                                <app-landing-page-select-single v-model="single.filter.category"
                                    ...
                                    :options="listCategory" @option-change="getData(true)" :class="'select-filter-categories'">
                            ...
                            <template v-else>
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 col-md-6" v-for="a in listData">
                                        <router-link :to="`/cullnary/${a.id}`">
                                            <div class="list-item-grid"
                                                :style="`background-image:linear-gradient(359.32deg, rgba(0, 0, 0, 0.5) 10%, rgba(0, 0, 0, 0) 99.42%), url('${a.culinaryThumbnail?.link}'),  url('${$noImageUrl()}');`">
                                                <div class="title">
                                                    {{ a.name }}
                                                </div>
                                                <div class="view-more">
...
<script>
    export default {
        ...
        mounted() {
            ...
            this.$axios().get(`menu-header-web?headerType=culinary`)
                .then(response => {
        ...
        methods: {
            ...
            getCategory(keyword, limit) {
                ...
                this.$axios().get(`select-list/culinary-category`, {
                        params
                    })
                    .then(response => {
                        this.listCategory = [];
